...
<body>
    <h1 class="product-one-ticket">Product Three Service Request</h1>
    <div class="form-container">
        ...
        <form action="#">
            ...
            <textarea id="problemDescription" class="form-textarea" placeholder="Describe your Product Three problem"></textarea>
